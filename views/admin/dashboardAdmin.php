        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
             ...
             <div class="container-fluid">
              <div id="calendar"></div>
              <h3 class="fs-4 mb-3 text-center">Agenda de Sala de Juntas</h3>
                <div class="col">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td scope="row">Lorem ipsum dolor sit amet consectetur, adipisicing elit.</td>
                      <td><button class="btn" id="">Agregar</button></td>
                    </tr>
                  </tbody>
                </table>                        
                </div>
                <h3 class="fs-4 mb-3 text-center">Agenda de Vehículo Utilitario</h3>
                <div class="col">
                  <table class="table table-striped">
                  <tbody>
                    <tr>
