...
<body>
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
             ...
             <div class="container-fluid">
              <div id="calendar"></div>
                <h3 class="fs-4 mb-3 text-center">Registro de Usuarios</h3>
                <div class="col">
                  <table class="table table-striped">
                  <tbody>
                    <tr>
                      <td scope="row">Anita Perez</td>
                      <td></td>
                    ...
                    <tr>
                      <td scope="row">Lorena Lopez</td>
                      <td><i class="fa-solid fa-check" style="color: #25f813;"></i></td>
    ...
    <?php include ('../evento/modal/modalUser.php'); ?>
    <script>
