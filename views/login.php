        ...
        <nav class="navbar navbar-expand-md navbar-light">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav d-flex justify-content-center align-items-center">
                    <li class="nav-item">
                        <a class="nav-link boton" href="admin/loginAdmin.php">Inicio de Sesión Admin</a>
                    </li>
                </ul>
                </div>
            </div>
    ...
    <main>
        <section class="container">
            <div class="form-login seccion-oscura">
                <form action="../includes/_sesion/loginUser.php" method="POST">
                    <fieldset>
                        <legend class="text-center">Inicia Sesión Usuario</legend>
                        <div class="mb-3">
